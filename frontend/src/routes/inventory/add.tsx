							...
							>
								...
								<Field label="Title" htmlFor="title">
										...
										>
											...
											{!suggestionsQuery.isFetching &&
												suggestionsQuery.isError && (
													...
													>
														Could not load suggestions (check API token /
														network).
													</div>
												)}
											{!suggestionsQuery.isFetching &&
												...
												suggestions.length === 0 && (
													...
													>
														No matches — keep typing or enter the title
														manually.
													</div>
												)}
											{suggestions.map((s) => (
									...
									<p className={mutedTextClass}>
										Type at least 2 characters for suggestions. Choosing one
										fills the exact PriceCharting title and matching console
										when possible.
									</p>
								</Field>
													...
													pricingPreviewQuery.data && (
														<>
															...
															<dl className={priceDlClass}>
																...
																{pricingPreviewQuery.data.salesVolume !=
																	null && (
																	<>
															...
															<p className={mutedTextClass}>
																Offer price below starts at the PriceCharting
																value for your selected condition; use the
																slider or type to adjust.
															</p>
														</>
													)}
											</div>
									...
									<Field label="Asking (optional)" htmlFor="offer-amt">
										...
										{offerSliderCents && (
											<input
												...
												onChange={(e) =>
													setOfferAmount(
														(Number(e.target.value) / 100).toFixed(2),
													)
												}
											/>
										)}
